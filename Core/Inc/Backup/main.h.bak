...
#define MUTE_GPIO_Port GPIOI
#define ENABLE_Pin GPIO_PIN_9
#define ENABLE_GPIO_Port GPIOI
#define SDMMC_CD_Pin GPIO_PIN_7
#define SDMMC_CD_GPIO_Port GPIOD
#define OE_Pin GPIO_PIN_5
#define OE_GPIO_Port GPIOI
#define CLIP_Pin GPIO_PIN_6
#define CLIP_GPIO_Port GPIOI
#define ERROR_Pin GPIO_PIN_7
#define ERROR_GPIO_Port GPIOI
